    ...
    final tips = [
      ...
      if (isAdmin)
        (
          ...
          ZadTokens.primary.withValues(alpha: 0.10),
          'لوحة الإدارة',
          'تعرض ملخص التطبيق وتدير المستخدمين والفرق العامة.',
          [
            'هذه الصفحة مخصصة للمؤسس والمسؤولين فقط.',
            'تعرض ملخصاً عاماً عن حالة التطبيق.',
            'تعرض بيانات المستخدمين بأمان، مع إخفاء جزء من رقم الهاتف.',
            'يمكن للمسؤول إيقاف المستخدمين أو إعادة تفعيلهم.',
            'تعرض الفرق العامة في التطبيق.',
          ],
        ),
    ];
    return [
